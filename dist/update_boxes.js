 ...
 */
async function _build_update_boxes(explorerUri, input_boxes, output_configs, sacrificed_erg = 0n, sacrificed_tokens = []) {
    // === VALIDATIONS ===
...
export async function update_boxes(explorerUri, input_boxes, output_configs, sacrificed_erg = 0n, sacrificed_tokens = []) {
    const builder = await _build_update_boxes(explorerUri, input_boxes, output_configs, sacrificed_erg, sacrificed_tokens);
 ...
 */
export async function update_boxes_chained(explorerUri, input_boxes, output_configs, sacrificed_erg = 0n, sacrificed_tokens = []) {
    return _build_update_boxes(explorerUri, input_boxes, output_configs, sacrificed_erg, sacrificed_tokens);
}
