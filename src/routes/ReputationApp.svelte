<script lang="ts">
    // app.css is imported once in +layout.svelte (template shell owns it).
...
<style>
    ...
    .view-switcher {
        position: fixed;
        /* sit below the template shell navbar (64px) instead of at the very top */
        top: 64px;
        left: 0;
        width: 100%;
        display: flex;
    ...
    .view-content {
        /* clear the template navbar (64px) + the in-page view-switcher (~53px) */
        padding-top: 120px;
    }
