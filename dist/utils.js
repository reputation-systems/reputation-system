 ...
 * @returns The serialized hex string.
 */
export function booleanToSerializer(value) {
 ...
 */
export function tupleToSerialized(isLocked, totalSupply) {
 ...
 */
export async function check_if_r7_is_local_addr(r7Value) {
    if (!get(connected))
        return false;
...
export function total_burned(proof) {
    const totalValue = proof.current_boxes.reduce((accumulator, box) => {
        return accumulator + BigInt(box.box.value);
    }, 0n);
