import { OutputBuilder, RECOMMENDED_MIN_FEE_VALUE, TransactionBuilder, ErgoAddress, SColl, SByte, SBool } from '@fleet-sdk/core';
 ...
 */
async function _build_update_opinion(explorerUri, opinion_box, polarization, content, token_amount_delta = 0, extra_erg = 0n, is_locked, main_box) {
 ...
 */
export async function update_opinion(explorerUri, opinion_box, polarization, content, token_amount_delta = 0, extra_erg = 0n, is_locked, main_box) {
    try {
        const builder = await _build_update_opinion(explorerUri, opinion_box, polarization, content, token_amount_delta, extra_erg, is_locked, main_box);
 ...
 */
export async function update_opinion_chained(explorerUri, opinion_box, polarization, content, token_amount_delta = 0, extra_erg = 0n, is_locked, main_box) {
    return _build_update_opinion(explorerUri, opinion_box, polarization, content, token_amount_delta, extra_erg, is_locked, main_box);
}
